...
@EnableJpaRepositories(basePackages = "pl.lodz.dmcs.javaee.repositories.entities",
...
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean EntityManagerFactory(EntityManagerFactoryBuilder builder) {
        ...
        return builder.dataSource(postgresAnalyticsDataSource()).packages(TodoItemEntity.class.getPackage().getName()).properties(properties).build();
    }
